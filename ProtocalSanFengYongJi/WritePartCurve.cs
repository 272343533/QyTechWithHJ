...
namespace QyTech.ProtocalHrzSanFengYongJi
{
    ...
    public class WritePartCurve : IProtocal
    {
        ...
        public override byte[] Create(object obj)
        {
            ...
            //判断该组织结构是否有曲线需要下发
            byte qxwd=38;//曲线温度 0-255
            sbyte outwd=0;//室外温度 -127-128
            ...
            {
                for (int i = (int)hrc_.CurevePointCount; i < 48 ; i++)
                {
        ...
        public override DeviceCmd CreateModbusRtuWriteCommandBySelfDefine(string simno)
        {
            ...
            HjPlcParaControlCurve obj_ = EntityManager<HjPlcParaControlCurve>.GetByPk<HjPlcParaControlCurve>("bsO_Id", Org.PId);
            return base.CreateModbusRtuWriteCommand<HjPlcParaControlCurve>(simno, obj_, bsProtItems);
        }
