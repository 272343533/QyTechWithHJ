...
namespace QyTech.ProtocalHrzSanFengYongJi
{
    public class Range : IProtocal
    {
        ...
        {
            return base.CreateModbusRtuReadCommand(simno, 0x01, 0x03, 0x200, 0x277 + 1 - 0x200);
            //01030200006D859F
        }
        ...
        public override DeviceCmd CreateModbusRtuWriteCommandBySelfDefine(string simno)
        {
            ...
            Org = BaseDABll.GetOrganize((Guid)Dev.AZWZ);
            HrzGathRange obj = EntityManager<HrzGathRange>.GetByPk<HrzGathRange>("bsO_Id", Org.PId);
