...
namespace QyTech.ProtocalGlfSheXian
{
    public class WritePart3 : IProtocal
    {
        ...
        public override int Parse(GPRS_DATA_RECORD recdPtr)
        {
            ...
            try
            {
                OTStandDataHrzControl3 obj = new OTStandDataHrzControl3();
                ...
                foreach (bsProtItem pi in bsProtItems)
                {
                    try
                    {
                        ...
                        obj = (OTStandDataHrzControl3)SetValueByReflectionFromBytes<OTStandDataHrzControl3>(obj, pi, propertyInfo, buff);
                ...
                EntityManager<OTStandDataHrzControl3>.Add<OTStandDataHrzControl3>(obj);
