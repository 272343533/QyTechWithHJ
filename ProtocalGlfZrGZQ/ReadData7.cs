...
namespace QyTech.ProtocalGlfZrGZQ
{
    public class ReadData7 : IProtocal
    {
       
        public static DateTime LastUpDate = DateTime.MaxValue;
        private int hrzNo = 7;

        public ReadData7(int bsP_Id)
            : base(bsP_Id)
        {
        ...
        //    return base.CreateModbusRtuReadCommand(simno, 0x01, 0x03, 0xD0, 0xFA - 0xD0 + 1);
