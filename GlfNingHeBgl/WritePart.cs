...
namespace QyTech.GlfNingHeBgl
{
    public class WritePart : IProtocal
    {
            ...
            try
            {
                ...
                foreach (bsProtItem pi in bsProtItems)
                {
                    try
                    {
                        ...
                        obj = (OTStandDataGlfControl1)SetValueByReflectionFromBytes<OTStandDataGlfControl1>(obj, pi, propertyInfo, buff);
                ...
                EntityManager<OTStandDataGlfControl1>.Add<OTStandDataGlfControl1>(obj);
        ...
        public override DeviceCmd CreateWeatherDownCommand(string simno, float wd, float rz = 0, float fs = 0)
        {
            return base.CreateModbusRtuWriteCommand(simno, 0x01, 0x001D, wd);
        }
