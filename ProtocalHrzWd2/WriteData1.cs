...
{
    public class WriteData1 : IProtocal
    {
        public WriteData1(int bsP_Id)
            : base(bsP_Id)
        {
        ...
        public override DeviceCmd CreateModbusRtuWriteCommandBySelfDefine(string simno)
        {
            ...
            List<OTStandHrzControlData> objs = EntityManager<OTStandHrzControlData>.GetAllByStorProcedure<OTStandHrzControlData>("splyGetClouldStorageData '", Dev.AZWZ.ToString() + "',4");
            return base.CreateModbusRtuWriteCommand<OTStandHrzControlData>(simno, objs[0], bsProtItems);
        }
