...
namespace QyTech.HrzYuanshixian
{
    public class Range : IProtocal
    {
        //public clsOTStandDataHrz1 obj = new clsOTStandDataHrz1();
        ...
        {
            return base.CreateModbusRtuReadCommand(simno, 0x01, 0x03, 0x200, 0x21C + 1 - 0x200);
            //01030200006D859F
        }
