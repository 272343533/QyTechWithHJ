...
{
    public class GLFCommonWritePart_DetNo : IProtocal
    {
        protected int DetailDevIndex = -1;
        protected int DetailDevNo = 0;
        protected OTStandDataHrzControl1 obj;

        //采集数据
        public GLFCommonWritePart_DetNo(int bsP_Id)
            : base(bsP_Id)
        {
        }
        ...
        public override int Parse(GPRS_DATA_RECORD recdPtr)
        {
            ...
            try
            {
                obj= new OTStandDataHrzControl1();
