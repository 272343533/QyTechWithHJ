...
{
    public class GLFCommonReadGGUnit_DetNo_LY : IProtocal
    {
        ...
        public GLFCommonReadGGUnit_DetNo_LY(int bsP_Id)
            : base(bsP_Id)
        {
        }
        ...
        public override int Parse(GPRS_DATA_RECORD recdPtr)
        {
            ...
            try
            {
                ...
                OTStandDataGlf_LY obj = new OTStandDataGlf_LY();
                ...
                foreach (bsProtItem pi in bsProtItems)
                {
                    try
                    {
                        ...
                        obj = (OTStandDataGlf_LY)SetValueByReflectionFromBytes<OTStandDataGlf_LY>(obj, pi, propertyInfo, buff);
                ...
                EntityManager<OTStandDataGlf_LY>.Add<OTStandDataGlf_LY>(obj);
