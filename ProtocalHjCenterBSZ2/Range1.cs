...
{
    public class Range1 : IProtocal
    {
        //public clsHJGathData11 obj = new clsHJGathData11();
        protected int DetailDevIndex = 2;
        public Range1(int bsP_Id)
            : base(bsP_Id)
        {
        }
        ...
        {
            return base.CreateModbusRtuReadCommand(simno, 0x01, 0x03, 0x60, 0x77 + 1 - 0x60);
            //01030200006D859F
        }
