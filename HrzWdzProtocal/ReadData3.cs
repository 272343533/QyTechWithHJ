...
{
    public class ReadData3 : IProtocal
    {
        ...
        public override DeviceCmd CreateReadCommand(string simno)
        {
            ...
            return base.CreateModbusRtuReadCommand(simno, 0x01, 0x03, 0x200, 0x260 - 0x200 + 1);
        ...
        public override int Parse(GPRS_DATA_RECORD recdPtr)
        {
            ...
            int resualt = 1;
            OnTimeHRZCollectData obj = new OnTimeHRZCollectData();
            ...
            try
            {
                ...
                foreach (bsProtItem pi in bsProtItems)
                {
                    try
                    {
                        ...
                        obj = (OnTimeHRZCollectData)SetValueByReflectionFromBytes<OnTimeHRZCollectData>(obj, pi, propertyInfo, buff);
                    }
                    catch (Exception ex)
                    {
                ...
                EntityManager<OnTimeHRZCollectData>.Add<OnTimeHRZCollectData>(obj);


                NewHRZCollectData newobj = EntityManager<NewHRZCollectData>.GetBySql<NewHRZCollectData>("Det_Id='" + obj.Det_Id.ToString() + "'");
                if (newobj == null)
                {
                    EntityOperate.Copy<NewHRZCollectData>(obj, newobj, "Det_Id");
                    EntityManager<NewHRZCollectData>.Add<NewHRZCollectData>(newobj);
                }
                else
                {
                    EntityOperate.Copy<NewHRZCollectData>(obj, newobj, "Det_Id");
                    EntityManager<NewHRZCollectData>.Modify<NewHRZCollectData>(newobj);
                }
