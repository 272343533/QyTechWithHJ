...
namespace QyTech.Protocal.Modbus
{
    ...
    public class ProgParams
    {
        ...
        static private int queryDataTimerInterval;
        ...
        static public int QueryDataTimerInterval
        {
            get { return queryDataTimerInterval; }
            set { queryDataTimerInterval = value; }
        }
        ...
        public static void readParamsFromXMLFile()
        {
            ...
            queryDataTimerInterval = int.Parse(XmlConfig.GetValue("QueryTimer"));
        ...
        public static bool writeParamsToXMLFile()
        {
            ...
            XmlConfig.SetValue("QueryTimer",string.Format("{0}", queryDataTimerInterval));
