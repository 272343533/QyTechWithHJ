...
{
    public class GLFCommonReadLUnit : IProtocal
    {
        ...
        public GLFCommonReadLUnit(int bsP_Id):base(bsP_Id)
        {
        ...
        public override int Parse(GPRS_DATA_RECORD recdPtr)
        {
            ...
            try
            {
                ...
                obj.Det_Id = detailDevs[DetailDevNo].Id;
                obj.Det_Name = detailDevs[DetailDevNo].DeviceName;
                obj.bsO_Id = Org.Id;
