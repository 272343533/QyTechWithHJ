...
namespace QyTech.GlfYuanshixian
{
    public class ProtocalFac : IProtocalFac
    {
        ...
        {
            return new string[] { "ReadData.CreateReadCommand", "ReadData1.CreateReadCommand", "ReadData2.CreateReadCommand", "ReadData3.CreateReadCommand", "ReadData4.CreateReadCommand", "ReadData5.CreateReadCommand" };
        }
