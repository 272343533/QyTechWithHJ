        ...
        public override int Parse(GPRS_DATA_RECORD recdPtr)
        {
            ...
            try
            {
                ...
                foreach (bsProtItem pi in bsProtItems)
                {
                    ...
                    {
                        log.Error("GlfYuanshixian.WritePart2.Parse(" + pi.FieldName + "):" + ex.Message);
                    }
                }
            ...
            {
                log.Error("GlfYuanshixian.WritePart2 parse:simno:" + recdPtr.m_userid + ":" + ex.InnerException + "-" + ex.Message);
                resualt = -1;
            }
            return resualt;
        }
