...
namespace InHandDtu
{
    public class DtuDll
    {
        ...
        [DllImport(@"inhandgprsdll.dll")]
        private static extern bool DLLGetModemByPosition(uint pos, ref ModemInfoStruct pModemInfo);

        [DllImport(@"inhandgprsdll.dll")]
        private static extern bool DLLGetNextData(ref ModemDataStruct pDataStruct, ushort waitseconds);
